...
export const MESSAGES_ZH_CN: MessageDict = {
  ...
  'popup.consent.title': '首次翻译前请确认',
  'popup.consent.description': '你主动选择翻译的可见网页文本会直接发送给所选 Provider。Provider 可能向你收费。TextDuet 不接收或转发这些数据。',
  'popup.consent.confirm': '我已了解，继续翻译',
  'popup.consent.loading': '正在检查隐私确认状态…',
  'popup.consent.error': '无法读取隐私确认状态，请重试。',
  'popup.consent.confirmFailed': '无法保存你的确认，请重试。',
  ...
  'popup.cost.totalTokens': '{count} token',
  ...
  'popup.settings.aria': '打开 TextDuet 设置',
  ...
  'options.sidebar.aria': '设置导航',
  'options.sidebar.expand': '展开导航',
  'options.sidebar.collapse': '收起导航',
  'options.sidebar.language': '语言',
  'options.sidebar.model': '模型',
  'options.sidebar.usage': '用量',
  'options.sidebar.advanced': '高级',
  ...
  'persistence.local.description': '使用密码解锁的 AES-GCM 保险箱加密。浏览器重启后会再次锁定，需要重新解锁。',
  'vault.section.title': '本地加密保险箱',
  'vault.section.badge': '密码保护',
  'vault.state.notCreated': '尚未创建保险箱',
  'vault.state.locked': '保险箱已锁定',
  'vault.state.unlocked': '保险箱已解锁（当前浏览器会话）',
  'vault.password.createLabel': '创建保险箱密码',
  'vault.password.unlockLabel': '解锁保险箱密码',
  'vault.password.confirmLabel': '确认密码',
  'vault.password.placeholder': '至少 8 个字符',
  'vault.action.create': '创建保险箱',
  'vault.action.unlock': '解锁保险箱',
  'vault.action.lock': '锁定保险箱',
  'vault.action.delete': '删除保险箱及已保存密钥',
  'vault.action.processing': '处理中…',
  'vault.action.clearCache': '清空加密译文缓存',
  'vault.hint': '持久 API Key 和译文缓存仅在本机加密保存。密码不会落盘；浏览器重启后需要重新解锁。',
  'vault.hint.locked': '保存或使用持久 API Key 前，请先解锁保险箱。',
  'vault.confirm.delete': '删除保险箱、所有持久 API Key 以及本地译文缓存？此操作无法撤销。',
  'vault.confirm.clearCache': '清空所有本地译文缓存？加密保险箱和持久 API Key 会保留。',
  'vault.status.created': '加密保险箱已创建',
  'vault.status.unlocked': '保险箱已解锁',
  'vault.status.locked': '保险箱已锁定',
  'vault.status.deleted': '保险箱及已保存密钥已删除',
  'vault.status.cacheCleared': '加密译文缓存已清空',
  'vault.status.passwordMismatch': '两次输入的密码不一致',
  'vault.status.passwordRequired': '请输入保险箱密码',
  'vault.status.failed': '保险箱操作失败',
  ...
  'translator.selection.error.consent': '请先在 Popup 或 Options 确认隐私说明',
  ...
  'language.custom.inputPlaceholder': '例如：fr-FR / ja-JP / zh-TW',
  'language.custom.translateButton': '翻译并切换',
  'language.custom.preparing': '正在准备翻译到 {language}…',
  'language.custom.progress': '正在翻译到 {language}… {done}/{total}',
  'language.custom.completed': '已翻译到 {language}',
  'language.custom.translateFailed': '无法翻译界面语言，请重试。',
  'language.custom.invalidTag': '请输入合法的 BCP-47 标签，例如 fr-FR 或 ja-JP。',
